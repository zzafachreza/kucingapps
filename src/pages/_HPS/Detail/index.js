...
import { getData, wenURL } from '../../utils/localStorage';
...
export default function ({ navigation, route }) {
    ...
    return (
        <SafeAreaView
            ...
            />
            <MyButton title="PRINT" warna={colors.primary} radius={0} Icons="print" onPress={() => Linking.openURL(wenURL + 'berita/print/' +
                route.params.id)} />
        </SafeAreaView>
    );
}
